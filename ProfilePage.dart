...
class _ProfilePageState extends State<ProfilePage> {
  ...
  bookAppointment(){
    // print("heloooooooooo");
     print(widget.userProfileUsername);
    Navigator.push(context, MaterialPageRoute(builder: (context) => AppointmentPage(gCurrentUser: widget.gCurrentUser, currentOnlineUserID: currentOnlineUserID, userProfileID: widget.userProfileID, SenderPic: widget.userProfilePic, Username: widget.userProfileUsername,)));
  }

  reschedule()
  {
    if(currentUser.room22 == 'C30')
      {
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text('Admin', style: TextStyle(color: Colors.blue),),
              onTap: gotoadmin,
            ),
